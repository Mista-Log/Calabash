            ...
            {!isSubmitted ? (
              <>
                ...
                <p className="m3-body-large text-[color:var(--md-sys-color-on-surface-variant)] text-center mb-8">
                  Enter your faculty email address and we'll send you a link to reset your password.
                </p>

                {/* Form */}
                <form onSubmit={handleSubmit} className="space-y-6">
                  <Input
                    id="forgot-password-lecturer-email"
                    type="email"
                    autoComplete="email"
                    value={email}
                    onChange={(e) => {
              ...
              <MdEmptyState
                ...
                onAction={() => router.push("/auth/login/lecturer")}
              />
            )}
          </div>
        </div>
